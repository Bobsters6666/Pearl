    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-14 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Pearl allows you to have conversations with any PDF document. Simply upload your file and start asking questions right away.
        </p>
      ...
      <div>
        <div className="relative isolate">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8 mt-16 sm:mt-24">
            <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-gray-90/10 lg:-m-4 lg:rounded-2xl">
              <Image 
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Try out Pearl today - it really takes less than a minute. 
              </span>
            </div>
          </li>
        </ol>
